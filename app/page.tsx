    ...
    <main className="min-h-screen px-8 py-0 pb-12 flex-1 flex flex-col items-center">
      <header className="w-full py-4 flex justify-between items-center">
        <div className="flex items-center">
          {/* <img src="/findsoltxlogo.png" alt="logo" className="w-35 h-10 mr-2" /> */}
          <div className="sm:inline text-xl font-bold">Find SOL Tx - powered by</div>
          <div className="w-2"></div>
          <img src="/reown-logo.png" alt="logo" className="w-35 h-10 mr-2" />
          <div className="sm:inline text-xl font-bold absolute left-1/2 transform -translate-x-1/2">
          <Link href="/find-tx">
            Find tx
          </Link>
        </div>
